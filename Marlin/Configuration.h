...
#define STRING_CONFIG_H_AUTHOR "(Paul Lowe)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Altered State Maker"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-50.00, -11.71, -0.740 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 19
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 2.5 // (mm) Default fade height.
  #endif
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_LAYER_HEIGHT   0.12  // (mm) Default layer height for G26.
